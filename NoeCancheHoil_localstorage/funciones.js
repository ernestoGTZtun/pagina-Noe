        ...
        switch (t) {
            case 1: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-success' role='alert'>Se agrego con exito el caballos</div>"
                );
                break;
            case 2: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-danger' role='alert'>Se elimino el caballo</div>"
                );
                break;
            default:
...
if (dbVacas.length !== 0) {
    ...
    $("#dbVacas-list").append("<h2> No tienes caballos</h2>");
}
...
function contarVacas(){
    ...
    $("#numeroVacas").append(
        "<a>Tienes actualmente" + "<br>" + "<span class='badge'>" + nVacas + "</span></a> caballos"
    );
    return nVacas;
}
